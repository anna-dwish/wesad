...
After performing 10-fold cross validation, the average accuracy rate on the test sets was `r round(mean(accuracies),3)` with the worst accuracy rate being `r round(minn(accuracies),3)` and the best accuracy rate being `r round(max(accuracies),3)`. In contrast, if we had naively predicted the most frequent class in the test set, our mean accuracy rate was `r round(mean(random_selection_accuracies),3)` with the worst accuracy rate being `r round(min(random_selection_accuracies),3)` and the best accuracy rate being `r round(max(random_selection_accuracies),3)`.
