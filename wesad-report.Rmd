...
threshold <- 0.5
model.chest.final <- augment(model.chest.final, type.predict = "response",type.residuals =  "pearson")
...
# ROC curve
p1 = ggplot(model.chest.final, aes(d = as.numeric(label), m = .fitted)) + 
  geom_roc(n.cuts = 0) + 
...
p2 = arm::binnedplot(x=model.chest.final$.fitted,y=model.chest.final$.resid,
                xlab="Predicted Probabilities", 
                main = "Binned Residual vs. Predicted Probabilities")

p3 = arm::binnedplot(x=model.chest.final$EDA_CHEST_MEAN,y=model.chest.final$.resid,
                xlab="RespiBAN Electrodermal Activity", 
                main = "Binned Residual vs. RespiBAN Electrodermal Activity")

p4 = arm::binnedplot(x=model.chest.final$Temp_CHEST_MEAN,y=model.chest.final$.resid,
...
pander(model.wrist.final, caption = "Table 1")
```
...
```{r  Wrist Model Diagnostics, echo=F, message=F, fig.height=6, fig.width=5}
threshold <- 0.5
