...
```{r  Chest Model Diagnostics Binned Residuals, echo=F, message=F, fig.height=4, fig.width=6, fig.align='center'}
...
From the ROC curve in Figure 3, we achieved an AOC of approximately 0.96, which indicates that our model has a relatively high accuracy for predicting the response. 
...
```{r  Wrist Model Diagnostics Binned Plot, echo=F, message=F, fig.height=4, fig.width=6, fig.align='center'}
...
From the ROC curve in Figure 5, we achieved an AOC of approximately 0.9273, which indicates that our model has a relatively high accuracy for predicting the response. 
...
collapse_rows_dt <- data.frame(Metric = c(rep("ECG (mV)", 2),
                                          rep("EDA ($\\mu$s)", 3),
                                          rep("EMG (mV)", 3),
                                          rep("Temp (C$^\\circ$)", 3),
                                          rep("Resp ($\\%$)", 2),
                                          ...
                                          rep("EDA ($\\mu$s)", 3),
                                          rep("Temp (C$^\\circ$)", 3)))
collapse_rows_dt2 <- data.frame(Description = c(rep("Electrocardiography: 700 Hz", 2),
...
nrow(collapse_rows_dt)
nrow(collapse_rows_dt2)
