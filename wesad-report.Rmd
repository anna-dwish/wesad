...
We noticed that some of the subjects' likelihood of being stressed had opposite relationships with respect to their recorded skin temperatures from the wristband. For example Subject 6 recorded higher skin temperatures during his stress condition while Subject 4 recorded lower skin temperatures during his stress condition. In this summary output of our interaction model, you will note that Subject's 6 positive interaction effect with temperature counteracts the main effect of temperature on the likelihood of stress. Specifically, for a 0.01 increase in degrees Celsius, we expect that the likelihood that subject 6 is stressed multiplies by a factor of 1.604. However for subject 4, we expect that for a 0.01 increase in degrees Celsisus, their likelihood of being stressed decreases by a factor of 0.525.
