...
From the ROC curve in Figure 5, we achieved an AUCC of approximately 0.9273, which indicates that our model has a relatively high accuracy for predicting the response. 
